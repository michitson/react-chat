...
5. ⏳ Publish v0.0.1 to npm — README + LICENSE written, version bumped, fresh build verified, `npm pack --dry-run` clean (11 files, 16.7 kB). Awaiting `npm login` then `npm publish`.
